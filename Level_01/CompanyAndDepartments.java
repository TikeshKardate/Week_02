...
class Department {
    ...
    public void displayDepartmentDetails() {
        ...
        for (int i = 0; i < employees.size(); i++) {
            ...
            employee.displayEmployeeDetails(); // Calling method in employee class to display employee details
        }
    }
...
public class CompanyAndDepartments {
    public static void main(String[] args) {  
        System.out.println("Kardate Consultancies\n\n");
        
        //Creating employees (objects)
        Employee employee1 = new Employee("Tikesh Kardate", 211006, "Executive Management");
        Employee employee2 = new Employee("Abhay Gautam",211005, "IT");
        Employee employee3 = new Employee("Amaan Sid", 211007, "HR");
        ...
        Company company = new Company("Kardate Consulatanices");

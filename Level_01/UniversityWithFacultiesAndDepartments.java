...
public class UniversityWithFacultiesAndDepartments{
    public static void main(String[] args) {
        ...
        University universityName = new University("Kardate University") ;

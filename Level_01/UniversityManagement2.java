...
public class UniversityManagement2{
    public static void main(String[] args) {
        // Create a university
        University university = new University("Kardate University");
        ...
        // Create faculties
        Faculty csFaculty1 = new Faculty("Tikesh Kardate", 101);
        Faculty csFaculty2 = new Faculty("Abhay Gautam", 102);
        ...
        Course networksCourse = new Course("Python");
        ...
        Student student2 = new Student("Pappu Kumar");

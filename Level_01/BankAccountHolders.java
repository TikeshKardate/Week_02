...
class Customer {
    ...
    // Constructor to initialize a customer with name, balance, and account number
...
class Bank {
    static String bankName = "AA Bank"; // Bank name
    private ArrayList<Customer> customers; // Association: A bank has multiple customers

    // Constructor to initialize the bank with an empty list of customers
    public Bank() {
    ...
    // Method to deposit money for a customer
    ...
    // Method to withdraw money for a customer
...
public class BankAccountHolders {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Tikesh", 100000, "211004");
        Customer customer2 = new Customer("Amaan", 110000, "211005");
        Customer customer3 = new Customer("Abhay", 120000, "211006");
        Customer customer4 = new Customer("Nishank", 130000, "211007");
        ...
        // Opening accounts for all customers in the bank
        bank.openAccount();
        ...
        bank.depositMoney(customer1, 50000); // Deposit for Tikesh
        System.out.println();

        bank.withdrawMoney(customer2, 100000); // Withdraw for Amaan
        System.out.println();
        
        bank.depositMoney(customer3, 70000); // Deposit for Abhay
        System.out.println();
        
        bank.withdrawMoney(customer4, 50000); // Attempting to withdraw for a customer not added to the bank
    }
}
